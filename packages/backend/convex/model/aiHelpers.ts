...
// The models array is passed via experimental_providerMetadata to support OpenRouter's fallback feature
const aiConfig = {
  model: openrouter(MODEL),
  mode: "json",
  temperature: 0.2,
  maxRetries: 0,
  // @ts-expect-error - OpenRouter specific parameter via provider metadata
