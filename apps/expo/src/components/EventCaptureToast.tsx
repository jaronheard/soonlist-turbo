...
function EventCaptureToastContent({
  event,
  hideNotification,
}: EventCaptureToastProps) {
...
export function showEventCaptureToast(
  event: EventCaptureToastProps["event"],
): void {
  void hapticSuccess();
