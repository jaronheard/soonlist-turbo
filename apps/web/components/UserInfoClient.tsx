...
type UserQuery = typeof api.users.getById | typeof api.users.getByUsername;

interface UserInfoClientProps<T extends UserQuery> {
  variant?: "default" | "description";
  self: boolean;
  preloadedUser: Preloaded<T>;
}
...
export function UserInfoClient<T extends UserQuery>({ variant, self, preloadedUser }: UserInfoClientProps<T>) {
