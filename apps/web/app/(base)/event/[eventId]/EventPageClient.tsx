  ...
  if (event === undefined || (event === null && trpcLoading)) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <Skeleton className="aspect-[9/16] w-full max-w-md rounded-2xl bg-neutral-3" />
        {/* Event details skeleton */}
        <div className="flex flex-col gap-4">
          <Skeleton className="h-8 w-3/4 bg-neutral-3" />
          <Skeleton className="h-6 w-1/2 bg-neutral-3" />
          <Skeleton className="h-6 w-2/3 bg-neutral-3" />
          <Skeleton className="h-24 w-full bg-neutral-3" />
        </div>
      </div>
    );
  }
